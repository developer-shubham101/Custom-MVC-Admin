                    ...
                    if (function_exists('finfo_open')) {
                        ...
                        if (is_resource($f)) {
                            ...
                            if (preg_match("/^([\w.-]+)\/(\w.-]+)(.*)$/i", $this->file_src_mime)) {
                                $this->file_src_mime = preg_replace("/^([\w.-]+)\/([\w.-]+)(.*)$/", '$1/$2', $this->file_src_mime);
    ...
    function process($server_path = null) {
        ...
        if ($this->processed) {
            ...
            if ($this->file_safe_name) { // formats the name
                $this->file_dst_name_body = utf8_encode(strtr(utf8_decode($this->file_dst_name_body), utf8_decode('Ã…Â Ã…Â½Ã…Â¡Ã…Â¾Ã…Â¸Ãƒâ‚¬Ãƒï¿½Ãƒâ€šÃƒÆ’Ãƒâ€žÃƒâ€¦Ãƒâ€¡ÃƒË†Ãƒâ€°ÃƒÅ Ãƒâ€¹ÃƒÅ’Ãƒï¿½ÃƒÅ½Ãƒï¿½Ãƒâ€˜Ãƒâ€™Ãƒâ€œÃƒâ€�Ãƒâ€¢Ãƒâ€“ÃƒËœÃƒâ„¢ÃƒÅ¡Ãƒâ€ºÃƒÅ“Ãƒï¿½ÃƒÂ ÃƒÂ¡ÃƒÂ¢ÃƒÂ£ÃƒÂ¤ÃƒÂ¥ÃƒÂ§ÃƒÂ¨ÃƒÂ©ÃƒÂªÃƒÂ«ÃƒÂ¬ÃƒÂ­ÃƒÂ®ÃƒÂ¯ÃƒÂ±ÃƒÂ²ÃƒÂ³ÃƒÂ´ÃƒÂµÃƒÂ¶ÃƒÂ¸ÃƒÂ¹ÃƒÂºÃƒÂ»ÃƒÂ¼ÃƒÂ½ÃƒÂ¿'), 'SZszYAAAAAACEEEEIIIINOOOOOOUUUUYaaaaaaceeeeiiiinoooooouuuuyy'));
                $this->file_dst_name_body = strtr($this->file_dst_name_body, array('ÃƒÅ¾' => 'TH', 'ÃƒÂ¾' => 'th', 'Ãƒï¿½' => 'DH', 'ÃƒÂ°' => 'dh', 'ÃƒÅ¸' => 'ss', 'Ã…â€™' => 'OE', 'Ã…â€œ' => 'oe', 'Ãƒâ€ ' => 'AE', 'ÃƒÂ¦' => 'ae', 'Ã‚Âµ' => 'u'));
