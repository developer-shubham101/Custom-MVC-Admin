...
class Zebra_Pagination
{
    ...
    public function variable_name($variable_name)
    {
     ...
     public function remove_variable($remove_variable)
    {

        // set the remove_variable name
        $this->_properties['remove_variable'] = strtolower($remove_variable);
    ...
    private function _build_uri($page)
    {
        ...
        // if page propagation is to be done through GET
            ...
            if($this->_properties['remove_variable']) unset($query[$this->_properties['remove_variable']]);
